...
#
# Usage:
#   .\manage-admin.ps1 add <username>                                    # Auto-finds service account
#   .\manage-admin.ps1 remove <username>                                 # Revoke admin
#   .\manage-admin.ps1 list                                              # List all admins
#   .\manage-admin.ps1 list -ServiceAccountPath "path\to\sa.json"       # Explicit path
#
# Examples:
...
switch ($Action) {
    "add" {
        ...
        try {
            $url = Get-FirebaseUrl "admin_users/$normalized"
    ...
    "list" {
        ...
        try {
            $url = Get-FirebaseUrl "admin_users"
