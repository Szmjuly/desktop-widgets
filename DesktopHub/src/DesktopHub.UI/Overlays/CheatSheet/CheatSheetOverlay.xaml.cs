...
public partial class CheatSheetOverlay : Window
{
    ...
    public void UpdateTransparency()
    {
        try
        {
            var transparency = _settings.GetCheatSheetWidgetTransparency();
            ...
            DebugLogger.Log($"CheatSheetOverlay: Transparency updated to {transparency:F2}");
        }
        catch (Exception ex)
        {
            DebugLogger.Log($"CheatSheetOverlay: UpdateTransparency error: {ex.Message}");
        }
    }
